...
def bin_search(key, sorted_dict):
    ...
    if i > j:
        ...
        return sorted_dict[sorted_keys[m]], count
...
if __name__ == "__main__":
    ...
    t, cnt1 = search_simple(key, players_dict)
    if (t == None):
    ...
    t, cnt2 = bin_search(key, sorted_dict)
    if (t == None):
        print("Ключ не найден")
    else:
        print(t)
    ...
    t, cnt3 = combined_search(key,segment_list)
    if (t == None):
        print("Ключ не найден")
    else:
        print(t)

    print("Интерации алгоритма полного перебора: ", cnt1)
    print("Интерации алгоритма бинарного поиска: ", cnt2)
    print("Интерации алгоритма комбинированного алгоритма: ", cnt3)
